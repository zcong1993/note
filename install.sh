...
NAME=${REPO}_${NUM_VERSION}_${OS}_${ARCH}
TARBALL=${NAME}.${FORMAT}
TARBALL_URL=${GITHUB_DOWNLOAD}/${VERSION}/${TARBALL}
CHECKSUM=note_${NUM_VERSION}_checksums.txt
